...
export default function Blog() {
    return (
        <section className="container mx-auto my-10 w-1/2">
            <div className="blog">
                ...
                <article className="flex gap-4 items-center my-4 ">
                    ...
                    <div className="flex-3/4">
                        {/* <a href="entrada.php"> */}
                            <h4 className="text-2xl font-bold mb-1 "> 
                                <span className="border-b-2 border-green-500">Construye una alberga en tu Hogar</span>en tu hogar
                            </h4>
                        {/* </a> */}
                        <p className="text-md mb-1">Escrito el: <span className="text-amber-500 font-bold"> 20/10/2019 </span> por: <span className="text-amber-500 font-bold"> Admin </span> </p>
                        <p className="text-xl mb-1">Consejos para construir una terraza en el techo de tu casa, con los mejores materiales y ahorrando dinero</p>
                ...
                <article className="flex gap-4 items-center my-4 ">
                    <div className="flex-1/4">
                        <img src="/img/blog3.jpg" alt="Entrada de blog" className="rounded"/>
                    </div>
                    <div className="flex-3/4">
                        {/* <a href="entrada.php"> */}
                            <h4 className="text-2xl font-bold mb-1 "> 
                ...
                <article className="flex gap-4 items-center my-4 ">
                    <div className="flex-1/4">
                        <img src="/img/blog4.jpg" alt="Entrada de blog" className="rounded"/>
                    </div>
                    <div className="flex-3/4">
                        {/* <a href="entrada.php"> */}
                            <h4 className="text-2xl font-bold mb-1 "> 
                                <span className="border-b-2 border-green-500">Guia para la Decoracion</span> de tu Habitacion
                            </h4>
                        {/* </a> */}
                        <p className="text-md mb-1">Escrito el: <span className="text-amber-500 font-bold"> 20/10/2019 </span> por: <span className="text-amber-500 font-bold"> Admin </span> </p>
                        <p className="text-xl mb-1">Consejos para construir una terraza en el techo de tu casa, con los mejores materiales y ahorrando dinero</p>
